...
def HOP_M1():
        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";'[FBAN/Orca-Android;FBAV/196.0.0.29;FBPN/com.facebook.orca;FBLC/zh_CN;FBBV/474580609;FBCR/3SE;FBMF/OPPO;FBBD/OPPO;FBDV/CPH1809;FBSV/4.5.2;FBCA/armeabi-v7a:armeabi;FBDM/density=1.5,width=720,height=1080;FB_FW/1;FBRV/armeabi-v7a:armeabi;]"
        return ua
