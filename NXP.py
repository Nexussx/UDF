...
def method():
    ...
    def start(user):
     try:
        ...
        loop+=1
        for pswd in pp:
              heads="Mozilla/5.0 ('Linux;"Android 11; 'Infinix X6816D /Build/RP1A.201005.001; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 'Chrome/116.0.0.0 Mobile Safari/537.36['"FBAN/EMA;FBLC/pl_PL;FBAV/373.1.0.8.104",]  #Put Your user Agent Here
